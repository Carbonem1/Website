...
{
	var aboutImage = $("#about-img");
	var resumeImage = $("#resume-img");
	var projectsImage = $("#projects-img");
	var contactImage = $("#contact-img");
	
	aboutImage.click(function()
	{
		resumeImage.fadeOut(600);
		projectsImage.fadeOut(600);
		contactImage.fadeOut(600);
	...
	resumeImage.click(function()
	{	
		aboutImage.fadeOut(600);
		projectsImage.fadeOut(600);
		contactImage.fadeOut(600);
		
		setTimeout(continueResumeExecution, 600);
		
		function continueResumeExecution()
		{
			resumeImage.css({"left": "240px", "position": "absolute"});
			resumeImage.animate({left: "-=240px"}, 400);
			setTimeout(continueResumeExecutionAgain, 400);
		}
		
		function continueResumeExecutionAgain()
		{
			window.location.href = "resume.html";
		}
	});
	
	projectsImage.click(function()
	{
		resumeImage.fadeOut(600);
		aboutImage.fadeOut(600);
		contactImage.fadeOut(600);
		
		setTimeout(continueProjectsExecution, 600);
		
		function continueProjectsExecution()
		{
			projectsImage.css({"left": "480px", "position": "absolute"});
			projectsImage.animate({left: "-=480px"}, 400);
			setTimeout(continueProjectsExecutionAgain, 400);
		}
		
		function continueProjectsExecutionAgain()
		{
	...
	contactImage.click(function()
	{
		...
		setTimeout(continueContactExecution, 600);
		
		function continueContactExecution()
		{
			contactImage.css({"left": "720px", "position": "absolute"});
			contactImage.animate({left: "-=720px"}, 400);
			setTimeout(continueContactExecutionAgain, 400);
		}
		
		function continueContactExecutionAgain()
		{
